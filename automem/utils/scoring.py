...
def _compute_metadata_score(
    ...
    # Keyword scoring applies to all match types, not just keyword-sourced
    # results: query tokens are checked against memory content regardless of
    # how the result was found (vector, keyword, relation, etc.).
